...
from core.models import Ingredient, IntakeRecommendation, Nutrient
from core.renderers import BrowsableAPIRenderer
from core.views.generics import ListAPIView, RetrieveAPIView
...
class IngredientView(ListAPIView):
    ...
    template_name = "core/data/component_search_result_list.html"
...
class IngredientDetailView(RetrieveAPIView):
    ...
    queryset = Ingredient.objects.prefetch_related("ingredientnutrient_set__nutrient")
...
class IngredientPreviewView(RetrieveAPIView):
    ...
    template_name = "core/data/preview.html"
