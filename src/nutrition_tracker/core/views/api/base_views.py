...
from core.views.generics import ListAPIView, ModelViewSet
from core.views.mixins import HTMXEventMixin
...
class ComponentCollectionViewSet(HTMXEventMixin, ModelViewSet):
    ...
    template_name = "core/data/collection_component_list_table_row.html"
    list_template_name = "core/data/collection_component_list.html"
    list_row_form_template_name = "core/data/collection_component_list_row_form.html"
...
class NutrientIntakeView(ListAPIView):
    ...
    template_name = "core/data/nutrient_tables.html"
