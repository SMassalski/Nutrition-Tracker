...
class WeightMeasurementViewSet(HTMXEventMixin, ModelViewSet):
    ...
    list_template = "core/data/weight_measurement_list.html"
    row_template = "core/data/weight_measurement_list_row.html"
    row_form_template = "core/data/weight_measurement_list_form_row.html"
    modal_template = "core/modals/add_weight_measurement_modal.html"
...
class ProfileApiView(
    ...
    renderer_classes = [TemplateHTMLRenderer, JSONRenderer, BrowsableAPIRenderer]
    template_name = "core/data/profile_information_form.html"
...
class TrackedNutrientViewSet(
    ...
    template_name = "core/data/tracked_nutrients_card.html"
    ...
    template_map = {
        "create": "core/data/tracked_nutrient_list_row.html",
        "list": {"list": "core/data/tracked_nutrient_list.html"},
        "form": {
            "add": "core/data/tracked_nutrient_list.html",
            "default": "core/components/tracked_nutrients_row_form.html",
        },
    }
...
class MalconsumptionView(GenericView):
    ...
    template_name = "core/data/malconsumption_cards.html"
    renderer_classes = [TemplateHTMLRenderer, JSONRenderer, BrowsableAPIRenderer]
    exclude = None
    permission_classes = [HasProfilePermission]
