...
def test_parse_nutrient_data_saves_nutrients(nutrient_csv, dummy_nutrient_class):
    """util.parse_nutrient_csv() reads and saves nutrient records"""
...
def test_parse_nutrient_csv_correctly_converts_units(
    ...
    """
    util.parse_nutrient_csv() converts non-standard units to regular
    units.
    """
    data = [
        {
...
def test_parse_nutrient_csv_ignores_records_with_specific_units(
    ...
    """
    util.parse_nutrient_csv() ignores records with certain units
